...
func TestBaselineStableInventoryAndDrift(t *testing.T) {
	r := model.Report{Host: model.Host{Hostname: "fixture"}, Findings: []model.Finding{
		{ID: "NET-001", Evidence: []model.Evidence{{Source: "ss", Value: "tcp 0.0.0.0:443 scope=public-wildcard process=sing-box"}, {Source: "ss", Value: "tcp 127.0.0.1:53 scope=loopback"}}},
